...
const FIB = 450
const DROPCOLS = [668, 7106]  # from leak_identify.jl (RNG reproduction)
const NSUB = 60
...
build(starcont[:, keepcols], chipgapmsk, joinpath(RUND, "built_new", "APOGEE_starcont_svd_60_f450_dropleak.h5"))
println("DONE")
